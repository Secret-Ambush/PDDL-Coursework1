(define (problem lunar-mission-2)
    ...
    (:init
        ...
        ;Astronaunt setup
        (astronaut-assigned-to alice lander1)
        (astronaut-assigned-to bob lander2)
        (astronaut-at-room alice dockingBay) ;there is logic in place to ensure that astronaunts can't switch between landers
        (astronaut-at-room bob controlRoom)
